...
def crearEntidades(documento,caso_id):
    ...
    for token in resultado_tokenizer:
        ...
        token_aux = TokensDoc(doc=documento, aparicion=token[3], tipo=tipo_token[token[1]], frase=token[2], lema=token[0], categoria=token[4], parrafo=parrafo, eliminado=False)
        token_aux.save()
